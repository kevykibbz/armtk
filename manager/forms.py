...
class OrderFieldsForm(forms.ModelForm):
    ...
    east_deliver=forms.CharField(widget=forms.TextInput(attrs={'class':'form-control','placeholder':'East deliver'}),required=False)
    ...
    acct_email=forms.EmailField(widget=forms.EmailInput(attrs={'class':'form-control','placeholder':'Acct email','required':False}),required=False)
